...
| `/tft/league/v1/by-puuid/{puuid}` | na1 | tier, rank, LP, wins, losses |
...
**Note**: The TFT league endpoint now accepts PUUID directly (`/tft/league/v1/by-puuid/{puuid}`), eliminating the need for the encrypted summoner ID and the summoner lookup step.

...
export const MOCK_PLAYERS = [
  // ── Challenger ───────────────────────────────────────────────
  {
    ...
    history: buildHistory([
      ...
      { daysAgo: 9,  tier: "GRANDMASTER", rank: "I", lp: 910 },
      { daysAgo: 8,  tier: "CHALLENGER",  rank: "I", lp: 1020 },
      { daysAgo: 7,  tier: "CHALLENGER",  rank: "I", lp: 1060 },
      { daysAgo: 6,  tier: "CHALLENGER",  rank: "I", lp: 1100 },
      { daysAgo: 5,  tier: "CHALLENGER",  rank: "I", lp: 1140 },
      { daysAgo: 4,  tier: "CHALLENGER",  rank: "I", lp: 1180 },
      { daysAgo: 3,  tier: "CHALLENGER",  rank: "I", lp: 1200 },
  ...
  // ── Grandmaster ──────────────────────────────────────────────
  {
    ...
    history: buildHistory([
      ...
      { daysAgo: 9,  tier: "MASTER",      rank: "I", lp: 810 },
      { daysAgo: 8,  tier: "GRANDMASTER", rank: "I", lp: 400 },
      { daysAgo: 7,  tier: "GRANDMASTER", rank: "I", lp: 425 },
      { daysAgo: 6,  tier: "GRANDMASTER", rank: "I", lp: 460 },
      { daysAgo: 5,  tier: "GRANDMASTER", rank: "I", lp: 472 },
  ...
  // ── Master ───────────────────────────────────────────────────
  {
    ...
    history: buildHistory([
      ...
      { daysAgo: 11, tier: "DIAMOND",  rank: "I",  lp: 95 },
      { daysAgo: 10, tier: "MASTER",   rank: "I",  lp: 30 },
      { daysAgo: 9,  tier: "MASTER",   rank: "I",  lp: 55 },
      { daysAgo: 8,  tier: "MASTER",   rank: "I",  lp: 90 },
      { daysAgo: 7,  tier: "MASTER",   rank: "I",  lp: 110 },
      { daysAgo: 6,  tier: "MASTER",   rank: "I",  lp: 130 },
      { daysAgo: 5,  tier: "MASTER",   rank: "I",  lp: 145 },
  ...
  // ── Diamond ──────────────────────────────────────────────────
  {
    ...
    history: buildHistory([
      ...
      { daysAgo: 13, tier: "PLATINUM", rank: "I",   lp: 92 },
      { daysAgo: 12, tier: "DIAMOND",  rank: "IV",  lp: 12 },
      { daysAgo: 11, tier: "DIAMOND",  rank: "IV",  lp: 30 },
      { daysAgo: 10, tier: "DIAMOND",  rank: "IV",  lp: 55 },
      { daysAgo: 9,  tier: "DIAMOND",  rank: "IV",  lp: 78 },
      { daysAgo: 8,  tier: "DIAMOND",  rank: "III", lp: 10 },
      { daysAgo: 7,  tier: "DIAMOND",  rank: "III", lp: 38 },
      { daysAgo: 6,  tier: "DIAMOND",  rank: "III", lp: 72 },
      { daysAgo: 5,  tier: "DIAMOND",  rank: "III", lp: 90 },
      { daysAgo: 4,  tier: "DIAMOND",  rank: "II",  lp: 20 },
      { daysAgo: 3,  tier: "DIAMOND",  rank: "II",  lp: 30 },
  ...
  // ── Emerald ──────────────────────────────────────────────────
  {
    ...
    history: buildHistory([
      ...
      { daysAgo: 9,  tier: "EMERALD", rank: "IV",  lp: 55 },
      { daysAgo: 8,  tier: "EMERALD", rank: "IV",  lp: 85 },
      { daysAgo: 7,  tier: "EMERALD", rank: "IV",  lp: 98 },
      { daysAgo: 6,  tier: "EMERALD", rank: "III", lp: 20 },
      { daysAgo: 5,  tier: "EMERALD", rank: "III", lp: 45 },
      { daysAgo: 4,  tier: "EMERALD", rank: "III", lp: 70 },
      { daysAgo: 3,  tier: "EMERALD", rank: "III", lp: 88 },
  ...
  // ── Platinum ─────────────────────────────────────────────────
  {
    ...
    history: buildHistory([
      ...
      { daysAgo: 11, tier: "GOLD",     rank: "I",   lp: 88 },
      { daysAgo: 10, tier: "PLATINUM", rank: "IV",  lp: 20 },
      { daysAgo: 9,  tier: "PLATINUM", rank: "IV",  lp: 45 },
      { daysAgo: 8,  tier: "PLATINUM", rank: "IV",  lp: 75 },
      { daysAgo: 7,  tier: "PLATINUM", rank: "IV",  lp: 92 },
      { daysAgo: 6,  tier: "PLATINUM", rank: "III", lp: 30 },
      { daysAgo: 5,  tier: "PLATINUM", rank: "III", lp: 55 },
      { daysAgo: 4,  tier: "PLATINUM", rank: "II",  lp: 10 },
      { daysAgo: 3,  tier: "PLATINUM", rank: "II",  lp: 40 },
  ...
  // ── Gold ─────────────────────────────────────────────────────
  {
    ...
    history: buildHistory([
      ...
      { daysAgo: 9,  tier: "SILVER", rank: "I",   lp: 95 },
      { daysAgo: 8,  tier: "GOLD",   rank: "IV",  lp: 25 },
      { daysAgo: 7,  tier: "GOLD",   rank: "IV",  lp: 48 },
      { daysAgo: 6,  tier: "GOLD",   rank: "IV",  lp: 70 },
      { daysAgo: 5,  tier: "GOLD",   rank: "IV",  lp: 88 },
      { daysAgo: 4,  tier: "GOLD",   rank: "III", lp: 15 },
      { daysAgo: 3,  tier: "GOLD",   rank: "III", lp: 55 },
  ...
  // ── Silver ───────────────────────────────────────────────────
  {
    ...
    history: buildHistory([
      ...
      { daysAgo: 7, tier: "SILVER", rank: "IV",  lp: 72 },
      { daysAgo: 6, tier: "SILVER", rank: "IV",  lp: 90 },
      { daysAgo: 5, tier: "SILVER", rank: "IV",  lp: 98 },
      { daysAgo: 4, tier: "SILVER", rank: "III", lp: 10 },
      { daysAgo: 3, tier: "SILVER", rank: "III", lp: 18 },
  ...
  // ── Bronze ───────────────────────────────────────────────────
  {
    ...
    history: buildHistory([
      ...
      { daysAgo: 7, tier: "BRONZE", rank: "III", lp: 40 },
      { daysAgo: 6, tier: "BRONZE", rank: "II",  lp: 55 },
      { daysAgo: 5, tier: "BRONZE", rank: "II",  lp: 72 },
      { daysAgo: 4, tier: "BRONZE", rank: "II",  lp: 90 },
      { daysAgo: 3, tier: "BRONZE", rank: "II",  lp: 98 },
  ...
  // ── Iron ─────────────────────────────────────────────────────
  {
    ...
    history: buildHistory([
      ...
      { daysAgo: 5, tier: "IRON", rank: "III", lp: 50 },
      { daysAgo: 4, tier: "IRON", rank: "III", lp: 30 },
      { daysAgo: 3, tier: "IRON", rank: "III", lp: 10 },
